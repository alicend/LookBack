...
func SetupRouter(db *gorm.DB) *gin.Engine {
	...
	{
		userGroup.GET("", handler.GetCategoryHandler)
		userGroup.PUT("/:categoryId", handler.UpdateCategoryHandler)
		userGroup.DELETE("/:categoryId", handler.DeleteCategoryHandler)
	}
